...
void CCoin::SetSprite(const std::string & spritePath, const sf::IntRect & spriteRect, float zoom)
{
	m_sprite.setTextureRect(sf::IntRect(spriteRect.left, spriteRect.top, spriteRect.width, spriteRect.height));
